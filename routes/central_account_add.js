exports.index = function (req,res,next){
	res.render('central-account_add',{title: 'User Management Add'
...
exports.role = function (req,res){
	req.db.collection('sys-role').find({}).toArray(function(err,recrole){    
		if (err) console.log(' central-account_add.role has error ',err);                                                 		
		// if(!err){                           	
	     	//console.log(recrole);
	     	res.send(recrole);
        	// res.json(recrole);                            	
...
exports.find = function (req,res){
	req.db.collection('userList').find({ "userName" : req.body.userName }).toArray(function(err,result){
  		if (err) console.log(' central-account_add.find has error ',err);
