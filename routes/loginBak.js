				...
				if (rec){
					...
					CheckPolicy(rec,function(message,showdialog){
						...
						if (message && (!showdialog)){
							...
							Fn_LevelUse(req,rec.branchFilter,rec.zoneFilter,rec.regionFilter,function(err,result){
...
function CheckPolicy(user,callback){
        ...
        if (user.passPolicy == true)  {
          ...
          if (user.userState == 'lock')  {
        	  returnmsg = 'Username �١�ЧѺ�����ҹ���ͧ�ҡ��͹���ʼ�ҹ�Դ�Թ 3 ���� ��سҵԴ��ͼ������к�';
          }
          if (user.userState == 'disable')  {
        	  returnmsg = 'Username �١�ЧѺ�����ҹ ���ͧ�ҡʶҹ��� disable';
          }
          if (user.userState == 'delete')  {
        	  returnmsg = 'Username �١ź ��سҵԴ��ͼ������к�';
          }
          var tx = new Date();
          
          if (user.expireDate != '' )  {
            if (tx > user.expireDate)  {
            	returnmsg = 'Username �١�ЧѺ�����ҹ���ͧ�ҡ������� ��سҵԴ��ͼ������к�';
            }
          }
          if (user.disableStart != '' && user.disableExpire != '')  {
            ...
            if (tx >= tb && tx <= te)  {
            	returnmsg = 'Username �١�ЧѺ�����ҹ ���ͧ�ҡʶҹ��� disable 㹪�ǧ���ҹ��';
            }              
          }
          if (dd < 0)  {
        	  returnmsg = '���ʼ�ҹ������� ��سҵԴ��ͼ������к�';
          }
        }
        var role = 0;
        ...
        if (role == 0)  {
          socket.emit('rmt-alert', {text: '��ҹ������Է��������ҹ�к� Smart Q', win: ''});
          break;
        }*/
       if (dd < 14)  {
    	   returnmsg = '������ա '+dd+' �ѹ ���ʼ�ҹ��������� ��س�����¹���ʼ�ҹ����';  
    	   showdialog = true;
        }
